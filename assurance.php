        ...
        <div class="heading-contact marginbot-50">
            ...
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2">
                    ...
                    <h2>Création d'un nouvel assureur</h2>
                    <p>
                        Pour ajouter un nouvel assureur a notre base de donnée entrez ses coordonnées
                    </p>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="num_tel" name="num_tel" placeholder="Entrez son numéro de téléphone" required="required" />
                        </div>
                        <div class="form-group">
                            <label for="mail">
                        ...
                        <div class="form-group">
                            ...
                            <input type="type" class="form-control" id="type" name="type" placeholder="Types d'assurances dont s'occupe cet assureur?" required="required" />
                        </div>
                        <div class="form-group">
                            <label for="faxe">
                                Numéro de faxe</label>
                            <input type="faxe" class="form-control" id="faxe" name="faxe" placeholder="Entrez numéro de faxe" required="required" />
                        </div>
                        

                    <div class="col-md-12">
                        <button type="submit" class="btn btn-skin pull-right" id="btnInscription" target="/accueil">
                            Ajouter l'assureur</button>
                    </div>
                </div>
                </form>
            </div>
